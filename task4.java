...
{  
    ...
    {  
        ...
        if(current==5)  
        {  
            l.setText("Que6:Arrays in java are?");  
            jb[0].setText("object references");jb[1].setText("objects");jb[2].setText("primitive datatype");jb[3].setText("if(All of the above)");  
        }  
        if(current==6)  
        {  
        ...
        if(current==8)  
        {  
            l.setText("Que9:Total constructor string class have?");  
            jb[0].setText("10");jb[1].setText("3");jb[2].setText("13");jb[3].setText("infinite");  
        }  
        if(current==9)  
        {  
            l.setText("Que10: Identify the return type of a method that does not return any value?");  
            jb[0].setText("int");jb[1].setText("void");jb[2].setText("double");  
                        jb[3].setText("none");  
        }  
        l.setBounds(30,40,450,20);  
